    ...
    <Card title="Datos Generales">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-1 gap-5">
        ...
        <div class="grid grid-cols-2 gap-5">
          ...
          <FromGroup label="Seleccionar Agencia que esta pasando" class="flex-1">
            <Select :options="originsbooking" v-model="booking.agency_id" class="client-select" />
          </FromGroup>

          <div class="flex items-center">
            <FromGroup label="Clientes" class="flex-1">
              <Select :options="customerOptions" v-model="booking.clients" class="client-select" />
            </FromGroup>
