<template>
  <div>
    ...
    <PartnerCompanyAddModal />
    <PartnerCompanyEditModal />
  </div>
</template>
...
import PartnerCompanyAddModal from "./PartnerCompanyAddModal.vue";
import PartnerCompanyEditModal from "./PartnerCompanyEditModal.vue";
