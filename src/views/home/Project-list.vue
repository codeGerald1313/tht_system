    ...
    <Card noborder>
      <div class="md:flex justify-between pb-6 md:space-y-0 space-y-3 items-center">
        ...
        <div class="flex items-center space-x-3"> <!-- Contenedor flex para alinear los elementos -->
          ...
          <InputGroup v-model="searchTerm" placeholder="Buscar cliente" type="text" prependIcon="heroicons-outline:search"
            merged />
        </div>
      </div>
...
import EditProject from "./ClientEditModal";
  ...
  methods: {
    ...
    async listarClientes() {
      try {
        ...
        const toast = useToast();
        toast.success('Clientes listados correctamente', {
          timeout: 1500, // Cierre automático después de 1.5 segundos
        });
