  ...
  <div>
    <Card noborder>
      <div class="md:flex pb-6 items-center">
        <h6 class="flex-1 md:mb-0 mb-3">Movimientos Caja Ericka</h6>
        ...
        <vue-good-table :columns="columns" styleClass=" vgt-table bordered centered " :rows="filteredRows"
          ...
          <template v-slot:table-row="props">
            ...
            <span v-if="props.column.field == 'concept'" class="font-medium">
              ...
              <span  v-if="props.column.field == 'amount'">S/ {{ props.row.amount }}</span>
...
export default {
  ...
  methods: {
    ...
    fetchMoneyRecords(date) {
      ...
      axios.get(`${import.meta.env.VITE_API_URL}/moneys-ericka/list-movements/`, {
        ...headers,
        params: {
