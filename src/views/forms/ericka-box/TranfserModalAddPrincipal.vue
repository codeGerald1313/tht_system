<template>
  <div>
    <Modal :activeModal="store.addmodalTrasnfer2" @close="store.closeModalTransfer2" title="Transferir a Caja Principal"
      centered>
...
const saveTransfer = () => {
  ...
  axios.post(`${import.meta.env.VITE_API_URL}/transfers-moneyboxes-ericka/transfer-caja-principal`, {
...
const cancel = () => {
  store.closeModalTransfer2(); // Cierra el modal al hacer clic en el botón "Cancelar"
};
