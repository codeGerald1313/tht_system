<template>
  <div>
    <Modal :activeModal="store.addmodal" @close="store.closeModal" title="Registrar Nuevo Egreso" centered>
...
const saveIngreso = () => {
  ...
  axios.post(`${import.meta.env.VITE_API_URL}/moneys/create-expense`, income.value, {
    ...headers
  })
    .then(response => {
