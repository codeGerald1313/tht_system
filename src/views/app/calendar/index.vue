<template>
  <div>
    <Card>
      ...
      <Modal labelClass="btn-outline-dark" :activeModal="showModal" @close="hideModal" title="Event">
        <!-- :validation-schema="schema" -->
        <Form @submit="onSubmit">
          <div class="space-y-3">
            <Textinput v-model="event.title" type="text" label="Event Name" placeholder="Insert Event name" />
          ...
          <div class="flex justify-between items-center mt-5">
            ...
            <Button text="save" btnClass="btn-success" type="submit" :isDisabled="!formisValid" />
          </div>
        </Form>
      </Modal>
      <Modal :activeModal="eventModal" @close="closeModal" title="Edit Event">
        <Form @submit="editSubmit">
          <div class="space-y-3">
            <Textinput v-model="editevent.editTitle" type="text" label="Event Name" placeholder="Insert Event name" />
          ...
          <div class="flex justify-between items-center mt-5">
            <div>
              <Button text="Delete" btnClass="btn-danger" type="button" @click="confirm" />
            </div>
            <div class="flex space-x-5">
              <Button text="close" btnClass="btn-light" @click="closeModal" type="button" />
              <Button text="save" btnClass="btn-success" @click="editSubmit" :isDisabled="!editformvIsvalid" />
            </div>
          </div>
        </Form>
      </Modal>
  ...
  methods: {
    ...
    editSubmit(e) {
      ...
      if (this.editformvIsvalid) {
        ...
        this.edit.setProp("classs", editcategory);
        this.successmsg();
    ...
    editEvent(info) {
      ...
      this.editevent.editcategory = this.edit.classs[0];
