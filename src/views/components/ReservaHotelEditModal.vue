  ...
  watch: {
    ...
    clientData: {
      handler(newData) {
        ...
        this.bookinghotel.booking_id = newData?.booking_data?.id !== undefined ? newData?.booking_data?.id : '';
        this.bookinghotel.client_id = newData?.client_data?.id !== undefined ? newData?.client_data?.id : '';
        ...
        this.bookinghotel.total = newData?.total !== null ? parseFloat(newData?.total).toFixed(2) : '';
         ...
         if (newData?.detailbedrooms_data) {
          this.projects = newData?.detailbedrooms_data?.map(detail => ({
            id: detail.id,
            hotelsbooking_id: detail.hotelsbooking_id,
            typebedroom_id: 344,
        ...
        console.log(this.bookinghotel?.total );
