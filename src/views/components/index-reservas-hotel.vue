<template>
  <div>
    ...
    <ReservasHotelList v-if="fillter === 'list' && !isSkeletionList" />

    <ReservaHotelAddModal />
    <ReservaHotelEditModal />
  </div>
</template>
...
import ReservasHotelList from "./ReservasHotelList";
import Grid from "./Projects-grid";
import { useProjectStore } from "@/store/project";
import ReservaHotelAddModal from "./ReservaHotelAddModal.vue";
import ReservaHotelEditModal from "./ReservaHotelEditModal.vue";
